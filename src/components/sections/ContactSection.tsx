...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="section">
            <div className="container text-center bg-dark-300 border-2 border-dark-200 p-20 rounded-3xl">
                <div className="flex flex-col lg:flex-row w-full h-full gap-10">
                    ...
                    <div className="w-full h-full grid grid-rows-3 gap-6">
                        <div className="flex flex-row w-full h-full bg-dark-200 border border-dark-100 p-6 rounded-xl items-center justify-between">
